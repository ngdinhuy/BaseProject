...
import com.example.fashionapp.component.FilterBottomSheet
...
@AndroidEntryPoint
class ShopFragment : Fragment(), ShopAdapter.GoToDetailEvent {
    ...
    private fun setUpEvent() {
        ...
        databinding.clFilter.setOnClickListener {
            val filterBottomSheet = FilterBottomSheet().show(activity?.supportFragmentManager!!,"")
        }
    }
