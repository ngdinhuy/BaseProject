package com.example.fashionapp.zalo_payment.helper

import com.example.fashionapp.zalo_payment.helper.HMac.HMacUtil.HMacHexStringEncode
import android.annotation.SuppressLint
import kotlin.Throws
import com.example.fashionapp.zalo_payment.helper.HMac.HMacUtil
...
object Helpers {
    ...
    fun getMac(key: String, data: String): String {
        return Objects.requireNonNull(HMacHexStringEncode(HMacUtil.HMACSHA256, key, data))!!
    }
}